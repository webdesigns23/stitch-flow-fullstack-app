...
export default function ProjectImageMeasurements({project, onImageUpdate}) {
	const [ showImageForm, setShowImageForm ] = useState(false);
	
	const images = project.project_images || [];

	const measurementImages = images.filter(img => img.image_type === "measurements");
