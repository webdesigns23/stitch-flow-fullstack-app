...
// 		<>
// 		<br></br>
// 			<label className="filter-label" style={{color: "rgb(63, 61, 61)"}}>
// 				<input
// 					type="radio"
// 					name = "filter-status"
// 					value = "all"
...
// 			</label>
// 			<label className="filter-label" style={{color: "rgb(199, 140, 150)"}}>
// 				<input
// 					type="radio"
// 					name = "filter-status"
// 					value = "planning"
...
// 			</label>
// 			<label className="filter-label" style={{color: "rgb(110, 94, 141)"}}>
// 				<input
// 					type="radio"
// 					name = "filter-status"
// 					value = "sewing"
...
// 			</label>
// 			<label className="filter-label" style={{color:"rgb(161, 155, 58)"}}>
// 				<input
// 					type="radio"
// 					name = "filter-status"
// 					value = "final_touches"
